...
from ner_util import set_seed, collate_fn
...
def main():
    ...
    parser.add_argument("--data_dir", default="../../datasets/CoNLL", type=str)
    ...
    model_path = os.path.join(model_dir, f"ner_{args.num_train_epochs}_epochs.pth")
