...
from linking.data_types.doc_types import (
    Doc,
)
...
from linking.model_components.mention_detection_layer import IGNORE_INDEX
from linking.utilities.general_utils import batch_items
