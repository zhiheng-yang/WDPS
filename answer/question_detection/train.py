...
from question_data_loader import boolq_data_loader
import sys
sys.path.append('..')
...
TRAINING_PATH = "../../datasets/questions/question_type_train.csv"
TEST_PATH = "../../datasets/questions/question_type_dev.csv"
