...
def main():
    ...
    TRAINING_PATH = os.path.join(args.data_dir, "question_type_train.csv")
    TEST_PATH = os.path.join(args.data_dir, "question_type_dev.csv")
    ...
    training_loader = question_data_loader(TRAINING_PATH, tokenizer, args.max_seq_length, train_params)
    testing_loader = question_data_loader(TEST_PATH, tokenizer, args.max_seq_length, test_params)
    ...
    output_model_file = 'palm_question_detection.bin'
    output_vocab_file = './'
